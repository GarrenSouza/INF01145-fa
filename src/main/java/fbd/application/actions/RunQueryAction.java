...
public class RunQueryAction implements UIAction{
    ...
    public void execute() {
        ...
        this.app.getQueryDescriptions().forEach(pair -> {output.append("| -> ").append(pair.getValue0()).append(" | ").append(pair.getValue1()).append("\n");});
            ...
            try {
                ...
                switch(option){
                    case 1 -> {
                        ...
                        userInput = reader.readLine();
                        ResultSet queryResult = this.app.runDatabaseOperation(userInput);
